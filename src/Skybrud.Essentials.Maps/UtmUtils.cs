...
namespace Skybrud.Essentials.Maps {
    ...
    public class UtmUtils {
        ...
        /// <summary>
        /// Converts UTM coordinates <paramref name="utmX"/> (easting) and <paramref name="utmY"/> (northing) to the corresponding <paramref name="latitude"/> and <paramref name="longitude"/>.
        /// </summary>
