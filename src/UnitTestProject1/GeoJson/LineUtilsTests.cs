...
namespace UnitTestProject1.GeoJson {
    ...
    public class LineUtilsTests  {
        ...
        public void ComputeOffset() {
            ...
            IPoint r1 = LineUtils.ComputeOffset(o, 100, 0, r);
            IPoint r2 = LineUtils.ComputeOffset(o, 100, 45, r);
            IPoint r3 = LineUtils.ComputeOffset(o, 100, 90, r);
            IPoint r4 = LineUtils.ComputeOffset(o, 100, 135, r);
            IPoint r5 = LineUtils.ComputeOffset(o, 100, 180, r);
            IPoint r6 = LineUtils.ComputeOffset(o, 100, 225, r);
            IPoint r7 = LineUtils.ComputeOffset(o, 100, 270, r);
            IPoint r8 = LineUtils.ComputeOffset(o, 100, 315, r);
            IPoint r9 = LineUtils.ComputeOffset(o, 100, 360, r);
